...
namespace RealWorldApp.Services
{
    public static class ApiService
    {
        ...
        public static async Task<bool> Login(string email, string password)
        {
            ...
            Preferences.Set("accesToken", result.access_token);
        ...
        public static async Task<List<PopularProduct>> GetPopulerProducts()
        {
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accesToken", string.Empty));
        ...
        public static async Task<CartSubTotal> GetCartSubTotel(int userId)
        {
            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("bearer", Preferences.Get("accesToken", string.Empty));
